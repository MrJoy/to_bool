...
class Object
  ##
  # Monkey-patch for Object to turn certain values into TrueClass or FalseClass
  ...
  # or "1" becomes true, things that coerce to strings like "false", "", "no",
  # or "0" become false -- and anything that's not pretty unambiguous causes
  # an exception.
  #
  # Specifically:
...
class NilClass
  ##
  # Monkey-patch for NilClass to match the API for the Object#to_bool monkey
  # patch.  Returns false.
  #
  def to_bool
    return false
...
class TrueClass
  ##
  # Monkey-patch for TrueClass to match the API for the Object#to_bool monkey
  # patch.  Returns true.
  #
  def to_bool
    return self
...
class FalseClass
  ##
  # Monkey-patch for FalseClass to match the API for the Object#to_bool monkey
  # patch.  Returns false.
  #
  def to_bool
    return self
